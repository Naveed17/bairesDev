            ...
            <div className="flex  space-x-1 max-w-sm mx-4">
                ...
                <div className="text-center">
                    ...
                    <div className="flex space-x-1.5 mt-2 justify-center">
                        <div className="w-2.5 h-2.5 bg-site-primary-500 dark:bg-site-primary-600 rounded-full animate-bounce"></div>
                        <div className="w-2.5 h-2.5 bg-site-primary-500 dark:bg-site-primary-600 rounded-full animate-bounce" style={{ animationDelay: '0.1s' }}></div>
                        <div className="w-2.5 h-2.5 bg-site-primary-500 dark:bg-site-primary-600 rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></div>
                    </div>
                </div>
            </div>
        </div>
